...
\usepackage{amssymb}            % matematické symboly, např. "Blackboard-Bold" (\mathbb{})
\usepackage{enumitem}           % pro jednodušší odstranění mezer mezi prvky listu (v itemize)
\usepackage[formats]{listings}  % Balíček pro sazbu zdrojových textů
\usepackage{cmap}               % balíček cmap zajišťuje, že PDF vytvořené pomocí 'pdflatex'
                                % je plně "prohledávatelné" a "kopírovatelné"
